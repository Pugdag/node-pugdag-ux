import {
	html, css, PugdagDialog, chunks, getRandomInt, shuffle,
	T, i18n
} from './pugdag-dialog.js';

class PugdagSeedsDialog extends PugdagDialog{
	...
	static get styles(){
		return [PugdagDialog.styles, css`
			...
			.container{max-height:var(--pugdag-dialog-container-max-height, 660px)}
...
PugdagSeedsDialog.define("pugdag-seeds-dialog");
