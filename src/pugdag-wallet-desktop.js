import {html, css, FlowFormat, i18n, T} from './pugdag-wallet-ui.js';
import {PugdagWalletMobile} from './pugdag-wallet-mobile.js';

export class PugdagWalletDesktop extends PugdagWalletMobile{
	...
	static get styles(){
		return [PugdagWalletMobile.styles, css`
			:host{overflow:hidden}
			.container{
				padding:var(--pugdag-wallet-container-padding, 15px);
			...
			.wallet-warning{
				...
				background-color:var(--pugdag-wallet-warning-bg, #fdf8e4);
			}
			...
			.right-area{
				...
				height:var(--pugdag-wallet-right-area-height, calc(100vh - 122px));
			...
			.top-menu{
				...
				position:var(--pugdag-wallet-top-menu-position, absolute);
				right:var(--pugdag-wallet-top-menu-right, 20px);
				top:var(--pugdag-wallet-top-menu-top, -4px);
				z-index:2;
			...
			.header{
				border-bottom:var(--pugdag-wallet-header-border-bottom, --2px solid var(--pugdag-wallet-tab-border-top-color, var(--flow-primary-color)));
			}
		`];
	}
	constructor() {
