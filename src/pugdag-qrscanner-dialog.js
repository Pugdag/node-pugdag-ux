...
class PugdagQRScannerDialog extends PugdagDialog{
	...
	static get styles(){
		return [PugdagDialog.styles, css`
			.container{
				...
				max-height:var(--pugdag-dialog-container-max-height, 620px);
			}
...
PugdagQRScannerDialog.define("pugdag-qrscanner-dialog");
