import {
	html, css, PugdagDialog, PUG, txListStyle,
	paginationStyle, buildPagination,
	renderPagination, T
} from './pugdag-dialog.js';

class PugdagTXDialog extends PugdagDialog{
	...
	static get styles(){
		return [PugdagDialog.styles, paginationStyle, txListStyle,
		css`
			:host{
				position:fixed;
			...
			.container{
				max-height:var(--pugdag-dialog-container-max-height, 90%);
				max-width:var(--pugdag-dialog-container-max-width, 90%)
			}
...
PugdagTXDialog.define("pugdag-tx-dialog");
